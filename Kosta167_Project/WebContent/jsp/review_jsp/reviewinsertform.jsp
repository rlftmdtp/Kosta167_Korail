...
<link rel="stylesheet" href="../../css/review_css/Review_insert.css"
	type="text/css" />
...
<body>
   ...
   <div id="hnn-wrap">
	...
	<form action="reviewinsertok.jsp" method="post"  enctype="multipart/form-data">  
		<input type="hidden" name="r_no" value="${review.r_no }">
		<input type="hidden" name="m_id" value="${review.m_id }">
		
		<table id="eb" border="1" cellpadding="0" cellspacing="0">
		<tr height="30">
			<td align="center" width="80">작성자</td>
			<td width="170">
				<input type="text" name="r_name" size="15">
			</td>	
		...
		<tr height="30">
			...
			<td width="170">
				<input type="password" name="r_pw" size="16">
			</td>
		</tr>
		...
		<tr height="30">			
			<td colspan="4">
				<textarea rows="10" cols="138" name="r_content"></textarea>
			</td>			
		</tr>
		<tr height="30">			
			<td colspan="4" align="center">
				<input id="tt" type="submit" value="글쓰기" style="color: white;back-ground: #black; width: 80px;height: 23px; outline: 0; border: 0">&nbsp;&nbsp;
				<input id="uu" type="reset" value="취소" style="color: white;back-ground: #black; width: 80px;height: 23px; outline: 0; border: 0">&nbsp;&nbsp;
			</td>			
		</tr>
	</table> 
	</form>
