 ...
 * 우편번호 창
 **/
var win_zip = function(frm_name, frm_zip1, frm_addr1, frm_addr2) {
    ...
    var complete_fn = function(data){
        ...
        of[frm_zip1].value = data.zonecode; //6자리 우편번호 사용
...
$(function(){
    ...
    */
    ...
    $(".notHangul").keyup(function(event){
		if(!(event.keyCode >=37 && event.keyCode<=40) && !(event.keyCode == 50 || event.keyCode == 190 || event.keyCode == 189 || event.keyCode == 109))
		{
